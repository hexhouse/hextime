		...
		<div>
			<div style="display: flex; align-items: baseline; gap: 0.75rem;">
				...
				<button
					...
					style="font-family: 'Courier', monospace; font-size: 0.72rem; color: rgba(255,255,255,0.25); background: none; border: 1px dotted rgba(255,255,255,0.15); border-radius: 2px; padding: 0.15em 0.5em; cursor: pointer; line-height: 1.4;"
				>{infoOpen ? 'hide' : 'how this works'}</button>
			</div>
			{#if infoOpen}
				<div style="margin-top: 0.75rem; font-family: 'Courier', monospace; font-size: 0.82rem; color: rgba(255,255,255,0.38); line-height: 1.7; max-width: 38rem; border-left: 1px dotted rgba(255,255,255,0.12); padding-left: 1rem;">
					...
					<p style="margin: 0 0 0.75rem 0;">Invoices are due monthly and paid on Wednesdays.</p>
					...
					<p style="margin: 0;">Caps represent the maximum number of hours Hex can compensate each maintainer for within a month, not a target or expectation, just a ceiling. We want everyone to feel confident that the work they do for Hex is recognized. If you work hours within your cap and invoice for them, you will be paid for that work.</p>
				</div>
			{/if}
		</div>
